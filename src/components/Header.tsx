...
const Header = () => {
  ...
  return(
    <header className="relative py-2 px-4 flex flex-wrap items-center justify-between bg-white border-b border-gray-200">
      <Link
        href="/"
      >
        <Image
      ...
      <nav
        className={isOpen ? 'flex-[100%] mt-8 text-center order-last' : 'hidden md:block'}
      >

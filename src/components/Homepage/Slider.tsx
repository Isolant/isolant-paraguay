    ...
    >
      <SplideSlide>
        <Slide
          ...
          title={<span>Isolant <strong className="font-semibold">Paraguay</strong></span>}
          text={<span>Isolant, la empresa de aislantes de espuma de polipropeno más grande de Argentina, <strong className="font-semibold">llegó a Paraguay</strong>.</span>}
          ctaLink="#empresa"
          ctaText="Conoce Más"
          isExternal={false}
        />
      ...
      <SplideSlide>
        <Slide
          ...
          title={<span><strong className="font-semibold">Atacama</strong></span>}
          text={<span>El aislante líquido para techos y muros de tu casa que baja la temperatura interior <strong className="font-semibold">de 6 a 8 grados</strong>.</span>}
          ctaLink="#empresa"
          ctaText="Conoce Más"
          isExternal={false}
        />

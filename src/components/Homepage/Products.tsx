...
const Products = () => {
  ...
  return(
    <section className="relative bg-gray-100">
      ...
      <button
        className="w-full absolute -bottom-8 bg-gradient-to-t from-gray-100 h-24 z-10 flex flex-col items-center justify-center gap-1 group"
      ...
      >
        ...
        <svg className={`group-hover:opacity-80 relative transform ${limit === -1 ? 'order-first rotate-180' : 'top-1 animate-bounce'}`} fill="none" height="8" viewBox="0 0 14 8" width="14" xmlns="http://www.w3.org/2000/svg"><path clip-rule="evenodd" d="m.292893.292893c.390524-.3905241 1.023687-.3905241 1.414217 0l5.29289 5.292897 5.2929-5.292897c.3905-.3905241 1.0237-.3905241 1.4142 0 .3905.390524.3905 1.023687 0 1.414217l-5.99999 6c-.39053.39052-1.02369.39052-1.41422 0l-5.999997-6c-.3905241-.39053-.3905241-1.023693 0-1.414217z" fill="#263a48" fill-rule="evenodd"/></svg>
      </button>
    </section>
  )
}

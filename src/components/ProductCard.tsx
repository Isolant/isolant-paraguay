  ...
  return(
    <div className="relative">
      ...
      <div className="relative mt-4 md:mt-6 flex flex-col gap-3">
        <h4 className="font-sans font-semibold text-gray-800 text-xl md:text-2xl">{title}</h4>
        <p className="font-sans text-gray-600 font-regular">
          {description}
        </p>
        <Link
          href={cta}
          className="text-secondary font-sans font-medium uppercase tracking-wider text-xs hover:opacity-80 transition ease-in-out duration-100 flex items-center gap-1"
        >
